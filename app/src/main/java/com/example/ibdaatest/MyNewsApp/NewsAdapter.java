package com.example.ibdaatest.MyNewsApp;
...
public class NewsAdapter extends ArrayAdapter<com.example.ibdaatest.MyNewsApp.News> {
    private final Context mContext;
    private TextView mDate, mTime;

    public NewsAdapter(Activity context, ArrayList<com.example.ibdaatest.MyNewsApp.News> news) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.ibdaatest.MyNewsApp.News currentNews = getItem(position);
        Glide.with(mContext)
